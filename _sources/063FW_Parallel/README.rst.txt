...
| 大纲                  | 小节                  | 链接                  |
+=======================+=======================+=======================+
| 分布式并行            | 01 基本介绍           | `PPT <./01.           |
|                       |                       | introduction.pdf>`__, |
|                       |                       | `视频 <https:         |
|                       |                       | //www.bilibili.com/vi |
|                       |                       | deo/BV1ve411w7DL/>`__ |
+-----------------------+-----------------------+-----------------------+
| 分布式并行            | 02 数据并行           | `PPT <./02.d          |
|                       |                       | ata_parallel.pdf>`__, |
|                       |                       | `视频 <https:         |
|                       |                       | //www.bilibili.com/vi |
|                       |                       | deo/BV1JK411S7gL/>`__ |
+-----------------------+-----------------------+-----------------------+
| 分布式并行            | 03 模型并行之张量并行 | `PPT <./03.ten        |
|                       |                       | sor_parallel.pdf>`__, |
|                       |                       | `视频 <https:         |
|                       |                       | //www.bilibili.com/vi |
|                       |                       | deo/BV1vt4y1K7wT/>`__ |
+-----------------------+-----------------------+-----------------------+
| 分布式并行            | 04 MindSpore张量并行  | `PPT <./04.mindsp     |
|                       |                       | ore_parallel.pdf>`__, |
|                       |                       | `视频 <https:         |
|                       |                       | //www.bilibili.com/vi |
|                       |                       | deo/BV1vt4y1K7wT/>`__ |
+-----------------------+-----------------------+-----------------------+
| 分布式并行            | 05 模型并行之流水并行 | `PPT <./05.pipel      |
|                       |                       | ine_parallel.pdf>`__, |
|                       |                       | `视频 <https:         |
|                       |                       | //www.bilibili.com/vi |
|                       |                       | deo/BV1WD4y1t7Ba/>`__ |
+-----------------------+-----------------------+-----------------------+
| 分布式并行            | 06 混合并行           | `PPT <./06.hyb        |
|                       |                       | rid_parallel.pdf>`__, |
|                       |                       | `视频 <https:         |
|                       |                       | //www.bilibili.com/vi |
|                       |                       | deo/BV1gD4y1t7Ut/>`__ |
+-----------------------+-----------------------+-----------------------+
| 分布式汇总            | 07 分布式训练总结     | `PPT <                |
|                       |                       | ./07.summary.pdf>`__, |
|                       |                       | `视频 <https:         |
|                       |                       | //www.bilibili.com/vi |
|                       |                       | deo/BV1av4y1S7DQ/>`__ |
