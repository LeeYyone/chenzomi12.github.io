...
| 大纲                  | 小节                  | 链接                  |
+=======================+=======================+=======================+
| AI框架基础            | 01 基本介绍           | `silde <./01.         |
|                       |                       | introduction.pdf>`__, |
|                       |                       | `video <https         |
|                       |                       | ://www.bilibili.com/v |
|                       |                       | ideo/BV1he4y1z7oD>`__ |
+-----------------------+-----------------------+-----------------------+
| AI框架基础            | 02 AI框架的作用       | `silde <./02.         |
|                       |                       | fundamentals.pdf>`__, |
|                       |                       | `video <https         |
|                       |                       | ://www.bilibili.com/v |
|                       |                       | ideo/BV1fd4y1q7qk>`__ |
+-----------------------+-----------------------+-----------------------+
| AI框架基础            | 03                    | `silde <              |
|                       | A                     | ./03.history.pdf>`__, |
|                       | I框架之争（框架发展） | `video <https         |
|                       |                       | ://www.bilibili.com/v |
|                       |                       | ideo/BV1C8411x7Kn>`__ |
+-----------------------+-----------------------+-----------------------+
| AI框架基础            | 04                    | `silde <./0           |
|                       | 编程                  | 4.programing.pdf>`__, |
|                       | 范式（声明式&命令式） | `video <https         |
|                       |                       | ://www.bilibili.com/v |
|                       |                       | ideo/BV1gR4y1o7WT>`__ |
+-----------------------+-----------------------+-----------------------+
